...
{
    public class Mid1 : JsonRoom
    {

        public Mid1(Game1.ROOMS room) : base(room)
        {
        ...
        {
            levelData = new LevelData("C:\\Users\\liaml\\Documents\\Code Shit\\CoreReactor\\CoreReactor\\Json\\Mid1.json");
            Time = 60 * 3;
