...
{
    public class Mid3 : JsonRoom
    {

        public Mid3(Game1.ROOMS room) : base(room)
        {
        ...
        {
            levelData = new LevelData("C:\\Users\\liaml\\Documents\\Code Shit\\CoreReactor\\CoreReactor\\Json\\Mid3.json");
            Time = 60 * 13;
