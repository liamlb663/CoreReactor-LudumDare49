...
{
    public class End1 : JsonRoom
    {

        public End1(Game1.ROOMS room) : base(room)
        {
        ...
        {
            levelData = new LevelData("C:\\Users\\liaml\\Documents\\Code Shit\\CoreReactor\\CoreReactor\\Json\\End1.json");
            coreGrabbed = true;
