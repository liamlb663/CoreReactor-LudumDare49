...
{
    public class Start2 : JsonRoom
    {

        public Start2(Game1.ROOMS room) : base(room)
        {
        ...
        {
            levelData = new LevelData("C:\\Users\\liaml\\Documents\\Code Shit\\CoreReactor\\CoreReactor\\Json\\Start2.json");
